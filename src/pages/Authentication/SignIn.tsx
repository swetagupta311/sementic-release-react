...
import { requestCodeSchema, submitCodeSchema } from './loginSchema';
import { loginSchemaEmail } from './loginSchemaEmail';
...
//   // step for determing the if code is sent or not
...
//       <div className="rounded-sm border border-stroke w-[90%]  md:w-[70%] bg-white shadow-default dark:border-strokedark dark:bg-boxdark my-20 mx-auto ">
//         <div className="flex flex-wrap items-cente">
//           <div className="hidden lg:block lg:w-1/2 w-full xl:block xl:w-1/2">
...
//               <p className="2xl:px-20 text-2xl font-bold">PMI Dashboard</p>
...
//           <div className="w-full border-stroke dark:border-strokedark lg:w-1/2 lg:border-l-2 xl:w-1/2 xl:border-l-2">
//             <div className="w-full p-4 sm:p-12.5 xl:p-17.5 lg:p-17.5">
//               <h3 className="mb-9 text-center text-lg font-bold text-black dark:text-white sm:text-title-xl2">
//                 Sign In to PMI Dashboard
//               </h3>
...
//                     ) : null}
//                     <div className="mb-5 text-right mt-2">
//                       <button
//                         type="submit"
...
//                       <MdOutlinePhone className="h-[28px w-[21px]" />
//                     </span>
//                   </div>
//                 </div>
...
//                         <p className="errormsg">{errors.code}</p>
//                       ) : null}
...
//                     disabled={loading || (step === 1 && timeLeft > 0)}
//                   >
//                     {loading && step === 2 ? (
//                       <p>Verifying...</p>
//                     ) : (
...
//                 <div className="mb-5 text-right flex justify-center items-center mt-2">
//                   <button
//                     type="button"
//                     className="cursor-pointer rounded-lg border border-green bg-green-500 p-2 text-white transition hover:bg-opacity-90"
//                     onClick={() => setLoginWithOtp(!loginWithOtp)}
//                   >
//                     {loginWithOtp ? 'Login with OTP' : 'Login With password'}
//                   </button>
//                 </div>
//               </div>
//               <ToastContainer />
...
const SignIn: React.FC = () => {
  ...
  const requestLogin = async (values) => {
    setLoading(true);
    try {
      const response = await api.post('/loginwithcred', {
        phone: values.phone,
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5 text-right">
                  <button
                    ...
                    disabled={loading}
                  >
                    {loading ? <p>Verifying...</p> : <p>Submit</p>}
                  </button>
                </div>
